...
then
    ...
    reader_checkpoint="${base_dir}/checkpoint/reader/nq-drqa/hf_bert_base.cp"
    retrieval_type="drqa"
...
then
    ...
    reader_checkpoint="${base_dir}/checkpoint/reader/nq-drqa-seen_only/hf_bert_base.cp"
    retrieval_type="drqa"
...
then
    ...
    dpr_retrieval_checkpoint="${base_dir}/checkpoint/retriever/single/nq/hf_bert_base.cp"
    dpr_index="${base_dir}/indexes/single/nq/full"
    reader_checkpoint="${base_dir}/checkpoint/reader/nq-single/hf_bert_base.cp"
    retrieval_type="dpr"
    db_name="psgs_w100.tsv"
...
then
    ...
    reader_checkpoint="${base_dir}/checkpoint/reader/nq-single-seen_only/hf_bert_base.cp"
    retrieval_type="dpr"
    db_name="psgs_w100_seen_only.tsv"
fi
